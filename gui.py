...
class AssistantGUI:
    ...
    def get_response(self, user_input):
        ...
        for chunk in self.assistant.chain.stream(user_input):
            yield chunk

    def get_response_simple(self, user_input):
        return self.assistant.chain.invoke(user_input)
    ...
    def render_user_input(self):
        ...
        if user_input and user_input != "":
            ...
            # response = self.get_response_simple(user_input)
            # st.write(response)
    ...
    def render(self):
        with st.sidebar:
            ...
            st.title("Umbrella Corporation Onboarding Assistant")
